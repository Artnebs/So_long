...
/*   Updated: 2025/02/15 15:30:15 by anebbou          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	load_textures(t_game *game)
{
	...
	game->textures->hud_moves = load_texture(game->mlx->id, "textures/hud_moves.xpm");
	game->textures->hud_collect = load_texture(game->mlx->id, "textures/hud_collect.xpm");
	game->textures->hud_lives = load_texture(game->mlx->id, "textures/hud_lives.xpm");
